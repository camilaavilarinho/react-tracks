...
class CreateTrack(graphene.Mutation):
    ...
    # we can use **kwargs pattern instead of passing all arguments, in case of a big list of arguments
...
class UpdateTrack(graphene.Mutation):
    ...
    def mutate(self, info, track_id, title, description, url):
        ...
        #The user that update a track has to be the same one that created it
...
class DeleteTrack(graphene.Mutation):
    # We only need to return the id of the track that was deleted
